...
type RotatingTextSplitBy = "characters" | "words" | "lines" | string;
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {elements.map(
              (wordObj: WordObj, wordIndex: number, array: WordObj[]) => {
                const previousCharsCount = array
                  .slice(0, wordIndex)
                  .reduce(
                    (sum: number, word: WordObj) =>
