  ...
  return (
    <div className="border-2 border-black bg-white">
      <div className="flex items-baseline justify-between gap-2 border-b-2 border-black bg-black px-4 py-2.5">
        ...
        <span className="font-black text-xs text-[#FF3000]">
      ...
      <dl>
        {rows.map((row, index) => (
          ...
          >
            ...
            <dt className="text-[11px] font-black uppercase tracking-wide text-[#555555]">
              {row.label}
            </dt>
            <dd className="text-right text-sm font-bold text-black sm:text-left">
              {row.value}
              {row.note && (
