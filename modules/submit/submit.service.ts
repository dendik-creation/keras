...
/** Submit the selected schedule ids ("perang submit") and parse the result. */
export async function submitSchedules(
  sessionValue: string,
  scheduleIds: string[],
  ...
  const messages = parseSubmitMessages(htmlContent);
